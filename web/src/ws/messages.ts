...
export type InputAssign = components['schemas']['InputAssign'];
export type InstrumentState = components['schemas']['InstrumentState'];
export type InstrumentSplit = components['schemas']['InstrumentSplit'];
